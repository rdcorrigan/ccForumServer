        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    expect(mockedAxios.post).toHaveBeenCalled();
                    expect(mockedAxios.post).toHaveBeenCalledWith("/topics/" + topicId + "/subscribers", { subscribers: subscribers });
                    expect(result).toStrictEqual(mockedResponse);
                    return [2];
            }
        });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    result = _a.sent();
                    expect(mockedAxios.post).toHaveBeenCalled();
                    expect(mockedAxios.post).toHaveBeenCalledWith("/topics/" + topicId + "/subscribers/removal", { subscribers: subscribers });
